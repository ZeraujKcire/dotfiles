...
\textheight 21cm       % Height of text (including footnotes & figures)
\textwidth 13.3cm        % Width of text line.
\widowpenalty=10000
\clubpenalty=10000
...
%
\renewcommand{\footnoterule}{\vspace{10pt}\hrule width 30mm}
...
%% Usage: \itjournalheading{1}{1993}{1-15}{8/93;}{9/93}
%%                      {Jane Q. Public and A. U. Thor}
%%        \itjournalheading{vol}{year}{pages}{Submitted}{published}{authors}

\def\firstpageno#1{\setcounter{page}{#1}}

\def\itjournalheading#1#2#3{\def\ps@itjournaltps{\let\@mkboth\@gobbletwo%
\def\@oddhead{\scriptsize ITALIAN JOURNAL OF PURE AND APPLIED MATHEMATICS -- #1\,#2#3 \hfill \small\thepage}%
%\def\@oddfoot{\scriptsize \copyright #2 #6. \hfill}%
\def\@evenhead{\scriptsize ITALIAN JOURNAL OF PURE AND APPLIED MATHEMATICS -- #1\,#2#3 \hfill \small\thepage}\def\@evenfoot{}}%
\thispagestyle{itjournaltps}}
...
\def\ShortHeadings#1#2{\def\ps@itjournalps{\let\@mkboth\@gobbletwo%
\def\@oddhead{\noindent {\scriptsize\sc #1} \hfill\thepage}%
\def\@oddfoot{\hfill \scriptsize\rm  \hfill}%
\def\@evenhead{\thepage \hfill{\scriptsize\sc #2} }%
\def\@evenfoot{\hfill \scriptsize\rm  \hfill}}%
\pagestyle{itjournalps}}
...
% Acknowledgments
\long\def\acks#1{\vskip 0.3in\noindent{\normalsize\bf Acknowledgments}\vskip 0.1in
\noindent #1}
...
%%% Theorem 1; Lemma 1; Corollary 1. Can cross-link to body text.
%%Example output as:- Example 1.2 (continuous maps).
