let g:quicktex_tex = {
		...
		\'cli' : "\\clip ",
		\'cod' : "\\codigo{<+++>} <++>",
		\'col' : "\\begin{columns}[t,fragile]\<CR>\\column{0.<+++>\\textwidth}\n<++>\n\\column{0.<++>\\textwidth}\n<++>\n\\end{columns}",
		...
		\'exam' : "\\begin{exampleblock}{\\vspace*{-3ex}}\<CR>\\begin{verbatim}\n<+++>\n\\end{verbatim}\n\\end{exampleblock}",
		\'fb' : "\\fbox{<+++>} <++>",
		...
		\'fig' : "\\begin{figure}[hbtp!]\<CR>\\centering\n\\includegraphics[width= <+++> \\linewidth, page = 1]{IMAGES/<++>/chess.pdf}\n\\end{figure}",
		\'figb' : "\\begin{figure}[hbtp!]\<CR>\\centering\n\\begin{overprint}\n\\includegraphics[width= <+++> \\linewidth, page = 1]{IMAGES/<++>/tikz.pdf}\n\end{overprint}\n\\end{figure}",
		\'fil' : "fill = ",
		\'flul' : "\\begin{flushleft}\<CR><+++>\n\\end{flushleft}",
		\'flur' : "\\begin{flushright}\<CR><+++>\n\\end{flushright}",
		\'foo' : "\\footnotesize ",
		\'for' : "\\foreach \\n in {1,...,<+++>} <++>",
		\'fr' : "\\begin{frame}[t,fragile]\n\\frametitle{\\<+++>secname}\n<++>\n\\end{frame}",
		\'gra' : "gray ",
		\'gre' : "green ",
		\'gri' : "(<+++>) grid (<++>);",
		\'he' : "help lines ",
		...
		\'ie' : "\\textit{i.e.} ",
		\'in' : "\\input{<+++>.tex}",
		\'inc' : "\\includegraphics[width= <+++> \\linewidth, page = 1]{IMAGES/<++>/tikz.pdf}",
		\'inc1' : "\\includegraphics[width= <+++> \\linewidth, page = 1]{IMAGES/<++>/<++>}",
		\'incf' : "\\node [opacity=0.7] at (<+++>,<++>) {\\includegraphics[width=  <++>, page = 1]{IMAGES/<++>/tikz.pdf}};",
		\'inv' : "\\invisible<<+++>> <++>",
		\'it' : "\\textit{<+++>} <++>",
		\'its' : "\\itshape ",
		\'it1' : "\\textit{<+++>}\\\\[2mm] <++>",
		...
		\'sep' : "\\begin{minipage}{0.6\\linewidth}\<CR><+++>\n\\end{minipage}\<CR>\\begin{minipage}{0.35\\linewidth}\<CR>\\centering\n<++>\n\\end{minipage}",
		\'sep2' : "\\begin{minipage}{0.6\\linewidth}\n\\begin{exampleblock}{\\vspace*{-3ex}}\n\\begin{verbatim}\<CR><+++>\n\\end{verbatim}\n\\end{exampleblock}\n\\end{minipage}% \\pause\<CR>\\begin{minipage}{0.35\\linewidth}\<CR>\\centering\n<++>\n\\end{minipage}",
		...
		\'t' : "\\begin{tikzpciture}\<CR><+++>\n\\end{tikzpicture}",
		\'ti' : "\\title{<+++>}",
		\'tik' : "\\begin{figure}[hbtp!]\<CR>\\centering\n\\begin{tikzpicture}\<CR>\\draw <+++>\n\\end{tikzpicture}\n\\end{figure}",
